...
<header class="header">
        ...
        <div class="header-right">
            <div class="user-info" id="user-info">
                ...
                <a href="profile.php"><img class="avatar" src="display_avatar.php?username=<?php echo $username; ?>" alt="Avatar" style="width: 50px; height: 50px; border-radius: 50%;"></a>
                <a href="profile.php"></a><h2 class="username"><?php echo $_SESSION['username']; ?></h2>
                <button class="dropdown-toggle" id="dropdown-toggle">&#x25BC;</button>
                <div class="dropdown-menu" id="dropdown-menu">
                    <a href="profile.php">Hồ sơ cá nhân</a>
                    <a href="room_callendar.php">Lịch phòng</a>
    ...
    <h1 style="font-family: 'Montserrat', sans serif; text-align:center;">Hồ sơ cá nhân</h1>
    <div class="container profile-container">
        <div class="avatar-section">
            <img class="box" src="display_avatar.php?username=<?php echo $username; ?>" alt="Avatar" style="width: 500px; height: 500px;">
            <form action="upload_avatar.php" method="post" enctype="multipart/form-data">
            <button type="submit"><input type="file" name="avatar" accept="image/*"></button>
            </form>
        </div>
        <div class="info-section">
            <h2>Thông tin cá nhân</h2>
            <p><strong>Họ tên:</strong> <?php echo $user['full_name']; ?></p>
            <p><strong>Giới tính:</strong> <?php echo $user['sex']; ?></p>
            <p><strong>Ngày sinh:</strong> <?php echo $user['birth']; ?></p>
            <p><strong>Mã định danh công dân:</strong> <?php echo $user['cccd']; ?></p>
